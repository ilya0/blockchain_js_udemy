...
Blockchain.prototype.chainIsValid = function(blockchain){
    ...
    for(var i = 1; i < blockchain.lenth; i++){
        ...
        if(current['previousBlockHash'] !== prevBlock['hash']) validChain = false;
    ...
    if(!correctNonce || !correctPreviousBlockHash || !correctHash || !correctTransaction ) validChain = true;
